      ...
      <div style={{ width: "100%", maxWidth: "400px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{
            ...
            <div>
              <div style={{ fontSize: "18px", fontWeight: "700", color: "#212529", letterSpacing: "-0.3px" }}>
                EMPIRE AI
              </div>
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: "20px", fontWeight: "600", color: "#212529", marginBottom: "6px", textAlign: "center" }}>
            تسجيل الدخول
          </h1>
          <p style={{ fontSize: "13px", color: "#6c757d", textAlign: "center", marginBottom: "28px" }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              ...
              style={{
                ...
                background: loading ? "#86efac" : "#25D366",
        ...
        <p style={{ textAlign: "center", marginTop: "20px", fontSize: "12px", color: "#adb5bd" }}>
